...
export const TERMS: Term[] = [
  { id: "ph", name: "pH（酸碱度）", nameEn: "pH", aka: "酸碱度", akaEn: "acidity / alkalinity", group: "基础",
  ...
  { id: "om", name: "有机质", nameEn: "Organic matter", group: "基础",
  ...
  { id: "cec", name: "CEC（阳离子交换量）", nameEn: "CEC", group: "基础",
  ...
  { id: "texture", name: "质地", nameEn: "Texture", group: "基础",
  ...
  { id: "aggregate", name: "团粒结构", nameEn: "Aggregation", group: "基础",
  ...
  { id: "n", name: "氮（N）", nameEn: "Nitrogen (N)", aka: "碱解氮", akaEn: "available N", group: "养分",
  ...
  { id: "alkn", name: "碱解氮", nameEn: "Available N", group: "养分",
  ...
  { id: "p", name: "磷（P）", nameEn: "Phosphorus (P)", aka: "有效磷", akaEn: "available P", group: "养分",
  ...
  { id: "avp", name: "有效磷", nameEn: "Available P", group: "养分",
  ...
  { id: "k", name: "钾（K）", nameEn: "Potassium (K)", aka: "速效钾", akaEn: "available K", group: "养分",
  ...
  { id: "avk", name: "速效钾", nameEn: "Available K", group: "养分",
    plain: "当季能用的钾。",
  ...
  { id: "ca", name: "交换性钙", nameEn: "Exchangeable Ca", group: "养分",
  ...
  { id: "al", name: "交换性铝", nameEn: "Exchangeable Al", aka: "铝毒 活性铝", akaEn: "aluminium toxicity", group: "养分",
  ...
  { id: "zn", name: "有效锌", nameEn: "Available Zn", group: "养分",
  ...
  { id: "b", name: "有效硼", nameEn: "Available B", group: "养分",
  ...
  { id: "ec", name: "EC（电导率）", nameEn: "EC", aka: "盐分", akaEn: "salinity", group: "检测",
  ...
  { id: "salt", name: "全盐", nameEn: "Total soluble salt", group: "检测",
    plain: "土里可溶盐一共有多少。",
  ...
  { id: "bulk", name: "容重", nameEn: "Bulk density", group: "检测",
  ...
  { id: "test", name: "测土配方", nameEn: "Test-based fertiliser", group: "检测",
  ...
  { id: "saline", name: "盐碱", nameEn: "Saline-alkali", group: "障碍",
  ...
  { id: "acid", name: "酸化", nameEn: "Acidification", group: "障碍",
    plain: "土越种越酸，根被铝伤害。",
  ...
  { id: "compaction", name: "板结 / 犁底层", nameEn: "Compaction / plough pan", group: "障碍",
  ...
  { id: "mg", name: "交换性镁", nameEn: "Exchangeable Mg", aka: "有效镁", akaEn: "available Mg", group: "养分",
  ...
  { id: "fe", name: "有效铁", nameEn: "Available Fe", aka: "缺铁黄化", akaEn: "iron chlorosis", group: "养分",
  ...
  { id: "mn", name: "有效锰", nameEn: "Available Mn", group: "养分",
  ...
  { id: "s", name: "有效硫", nameEn: "Available S", group: "养分",
  ...
  { id: "cu", name: "有效铜", nameEn: "Available Cu", group: "养分",
  ...
  { id: "mo", name: "有效钼", nameEn: "Available Mo", group: "养分",
  ...
  { id: "porosity", name: "孔隙度", nameEn: "Porosity", group: "基础",
  ...
  { id: "fc", name: "田间持水量", nameEn: "Field capacity", group: "基础",
  ...
  { id: "gley", name: "潜育化", nameEn: "Gleying", aka: "冷浸田 青灰土", akaEn: "gleyed / cold-soaked paddy", group: "障碍",
  ...
  { id: "replant", name: "连作障碍", nameEn: "Replant trouble", aka: "重茬", akaEn: "continuous cropping", group: "障碍",
...
export function termView(t: Term, lang: Lang) {
  if (lang !== "en") return { name: t.name, aka: t.aka, plain: t.plain, detail: t.detail, group: t.group };
  return { name: t.nameEn, aka: t.akaEn, plain: t.plainEn, detail: t.detailEn, group: t.group };
}

/** 文章「相关检测指标」跳到百科对应词条。 */
export function encyclopediaAnchor(name: string): string {
...
export function indicatorView(name: string, lang: Lang): string {
  if (lang !== "en") return name;
  const t = TERMS.find((x) => x.id === encyclopediaAnchor(name));
  return t?.nameEn ?? name;
}
...
export { wikiToArticle, WIKI_GUIDES } from "@/lib/encyclopedia-guides";
